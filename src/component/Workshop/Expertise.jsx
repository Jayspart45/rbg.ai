export default function Expertise() {
    return (
      <div className="w-full flex bg-gray-200 flex-col justify-center items-center min-h-[50vh]">
        <h1 className="text-center font-Poppins font-bold text-3xl mb-10 text-zinc-700">
          Expert Talks from Academic & Industry: Elevating Your Understanding
        </h1>
        <div className="flex flex-col text-zinc-600 font-medium text-lg">
